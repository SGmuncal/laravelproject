...
@section('admin_content')
	<div class="jumbotron" style="background-color:white;">
		...
		<div class="container">
			<center>
				<h1>Create New Content For Company Story Page</h1>
					...
					<div class="col-md-6">
						<div class="card">
						  <div class="card-body" style="background-color:#6D7FCC; border-color:#6D7FCC; color:white;">
						    ...
						    <br><br>
						    <a href="{{ url('company_insert_manager') }}" class="btn btn-outline-primary" style="border-color:white; color:white;">Press to Insert Data </a>
						  </div>
						</div>
						<br><br>
					</div>
					...
					<div class="col-md-6">
						<div class="card">
						  <div class="card-body">
						    ...
						    <br><br>
						    <a href="{{ url('company_update_manager') }}" class="btn btn-primary">Press to Update Data</a>
						  </div>
						</div>
					</div>
				</div>
