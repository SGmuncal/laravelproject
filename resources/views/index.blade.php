    ...
    <div class="row">
        ...
        <div class="col-md-6">
                ...
                <div id="mission-vision-section">
                    ...
                    <h1 class="display-4" id="mission_header" style="font-size:45px; color:white;"></h1>
        ...
        <div class="col-md-6">
                ...
                <div id="mission-vision-section">
                    ...
                    <h1 class="display-4" id="vision_header" style="font-size:45px; color:white;"></h1>
...
<div class="jumbotron" style="background: linear-gradient(125deg, #00e4d0, #5983e8);">
    ...
    <div class="container">
         <div class="row">
            <div class="col-md-6">
                ...
                <a class="btn btn-primary btn-lg" id="btn_visit_us" href="" role="button">Visit Us</a>  
            </div>
