...
@section('content')
 <center>
        ...
        <div class="jumbotron" style="background-color:white;">
            <div class="container">
                <div class="col-md-4">
                    <i class="fas fa-map-marker-alt" style="font-size:55px; color:#3204ad;"></i>
                </div>
            </div>
                ...
                <?php 
                    ...
                    if(isset($_GET['inpaddress']))
                    {
                        ...
                        if($val == 'Winnipeg')
                        {
                            echo '
                                ...
                                <li class="" ><a href="Winnipeg" class="city" style="font-weight:bold; font-weight:bold; color:#3204ad; border-bottom:1px solid #3204ad; text-decoration:none;">WINNIPEG </a></li> -
                        ...
                        else if($val == 'Edmonton')
                        {
                            echo '
                                ...
                                <li class=""><a href="Edmonton" class="city" style="font-weight:bold; color:#3204ad; border-bottom:1px solid #3204ad; text-decoration:none;">EDMONTON </a></li> -
                                <li class=""><a href="Calgary" class="city" style="font-weight:bold; color:black; text-decoration:none;">CALGARY</a></li>
                        ...
                        else if($val == 'Calgary')
                        {
                            echo '
                                ...
                                <li class="" ><a href="Winnipeg" class="city" style="font-weight:bold; color:black; text-decoration:none;">WINNIPEG </a></li> -
                                <li class=""><a href="Edmonton" class="city" style="font-weight:bold; color:black; text-decoration:none;  ">EDMONTON </a></li> -
                                <li class=""><a href="Calgary" class="city" style="font-weight:bold; color:#3204ad; border-bottom:1px solid #3204ad; text-decoration:none;">CALGARY</a></li>
                    ...
                    else
                    {
                        echo '
                                ...
                                <li class="" ><a href="Winnipeg" class="city" style="font-weight:bold; color:#3204ad; border-bottom:1px solid #3204ad; text-decoration:none;">WINNIPEG </a></li> -
                                <li class=""><a href="Edmonton" class="city" style="font-weight:bold; color:black; text-decoration:none;">EDMONTON </a></li> -
                                <li class=""><a href="Calgary" class="city" style="font-weight:bold; color:black; text-decoration:none;">CALGARY</a></li>
                    ...
                    success:function(response) {
                        ...
                        $.each(directories, function (index, el) {
                            ...
                            directories_data = '<p style="font-weight: 300; position: relative; left:10px;" id="location_ids">\
                                ...
                                <text style="font-size: 13px;">'+string_businesshour+'</text><br><br>\
                                <button style="font-size: 15px;" class="btn btn-primary" id="btnDirectory" data-toggle="modal" data-target="#myStore'+string_storeID+'">\
