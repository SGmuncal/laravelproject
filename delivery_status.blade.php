...
<br><br>
		...
		<div class="row">
			<div class="col-md-3">
				<div id="launchPad" style="overflow-y: scroll; height:auto; width: 100%;">
					<div class="stackHdr" style="background: linear-gradient(-20deg, #00e4d0, #5983e8); color:white; text-align: center;  width: 100%;">
				        <text>Open Orders</text>
				    </div>    
					@foreach($customer_orders_details as $transac_details)
						@if($transac_details->delivery_status == 'Processing')
							<div class="drag-wrapper from-launch" data-customer-or-number='{{$transac_details->or_number}}' data-driver='{{$transac_details->driver_firstname}}'>
							    <div class="card addStyleHover" style="opacity: 0.8">
							        <div class="card-body" style="font-weight: bold; text-align: center;" >
							            <h5 class="card-title" style="text-align: center;">
							                ...
							                @if($transac_details->or_number == "")
							                	<h6 class="card-subtitle mb-2 text-muted numbers" style="font-weight: 300; color:black !important; font-weight: bold;" data-toggle="modal" data-target="#modalOrdernumber" data-order-id='{{$transac_details->order_id}}' data-customer-id='{{$transac_details->customer_id}}' id="clickedOrdernumberappend">OR # {{$transac_details->or_number}}</h6>
							                @else
							                ...
							                <h6 class="card-subtitle mb-2 text-muted" style="color:black !important; font-weight: bold;">Driver: {{$transac_details->driver_firstname}}</h6><br>
							                ...
							                <input type="hidden" name="" class="or_number" value="{{$transac_details->or_number}}">
					               			 ...
					               			 @if($transac_details->driver_firstname != "")
							                @else
							                    <button href="#" data-order-id='{{$transac_details->order_id}}' data-customer-id='{{$transac_details->customer_id}}' style="" data-toggle="modal" data-target="#driver_assign" type="button" class="card-link btn btn-primary" id="assign_btn">Assign Driver</button>
							                @endif
					               			 ...
					               			 <button href="#" class="card-link btn btn-primary gather_customer_order" data-order-id='{{$transac_details->order_id}}' data-customer-id='{{$transac_details->customer_id}}'  data-toggle="modal" id="detailsBtn" data-target="#customer_detail_delivery">Details</button>
			...
			<div class="col-md-3">
				<div id="dropZone">
				    <div class="stack"  style=" width: 100%;">
				        ...
				        <center>
				       		<div class="kitchen" id="drop2" style="overflow-y: scroll; height:auto;  width: 100%;">
				            	@foreach($customer_orders_details as $transac_details)
									@if($transac_details->delivery_status == 'Kitchen')
										<div class="drag-wrapper from-kitchen2" data-customer-or-number='{{$transac_details->or_number}}' data-driver='{{$transac_details->driver_firstname}}'>
										    <div class="card addStyleHover" style="opacity: 0.8">
										        <div class="card-body" style="font-weight: bold; text-align: center;" >
										            <h5 class="card-title" style="text-align: center;">
			...
			<div class="col-md-3">
				<div id="dropZone">
				    <div class="stack"  style=" width: 100%;">
				        ...
				        <center>
				        	<div class="Road" style="overflow-y: scroll; height:auto;  width: 100%;">
				            	@foreach($customer_orders_details as $transac_details)
									@if($transac_details->delivery_status == 'Road')
										<div class="drag-wrapper from-kitchen3" data-customer-or-number='{{$transac_details->or_number}}' data-driver='{{$transac_details->driver_firstname}}'>
										    <div class="card addStyleHover" style="opacity: 0.8">
										        <div class="card-body" style="font-weight: bold; text-align: center;" >
										            <h5 class="card-title" style="text-align: center;">
									                <i class="far fa-user-circle" style="font-size:30px; color:#800000; "></i>
			...
			<div class="col-md-3">
				<div id="dropZone">
				    <div class="stack"  style=" width: 100%;">
				        ...
				        <center>
				        	<div class="Completed" style="overflow-y: scroll; height:auto;  width: 100%;">
				            	@foreach($customer_orders_details as $transac_details)
									@if($transac_details->delivery_status == 'Completed')
										<div class="drag-wrapper from-kitchen4" data-customer-or-number='{{$transac_details->or_number}}' data-driver='{{$transac_details->driver_firstname}}'>
										    <div class="card addStyleHover" style="opacity: 0.8">
										        <div class="card-body" style="font-weight: bold; text-align: center;" >
										            <h5 class="card-title" style="text-align: center;">
									                <i class="far fa-user-circle" style="font-size:30px; color:#800000; "></i>
...
<form action=""  method="post" enctype="multipart/form-data">
	<div class="modal fade" id="modalOrdernumber">
			...
			<div class="modal-dialog modal-md modal-dialog-centered">
      			<div class="modal-content">
			       <div class="modal-body">
					    ...
					    <div class="row">
		     				<div class="col-md-10" style="color:#3204ad"><h5>Enter the order number</h5></div>

		     				<div class="col-md-2"><button type="button" class="btn btn-primary" id="close_order_number">X</button></div>
	
	     				</div>
	     				<div class="container-fluid">
					    <hr>
					    <label>Order Number</label>
					    <input type="text" name="" class="order_number_added form-control" placeholder="B4XX33322AA" class="form-control">
					    ...
					    <br>
		     			...
		     			<div class="col-md-4 float-right">
		     				<button type="button" class="btn btn-primary form-control" id="save_order_number">Save</button>
		     			</div>

					    <!-- INPUT HIDDEN APPEND -->
					    <input type="hidden" class="order_id_append" value="" name="">
					    <input type="hidden" class="customer_id_append" value="" name="">
		     	   </div>
			    </div>
		    </div>
					                            ...
					                            <tbody>
					            					...
					            					@foreach($driver_details as $details)
					            						<tr>
					            							...
					            							<td>{{$details->driver_firstname}}</td>
