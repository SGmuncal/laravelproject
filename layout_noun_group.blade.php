...
@section('admin_content')
	...
	<div class="row">
		...
		<div class="col-md-3">
			<a href="" class="btn btn-primary form-control" id="hoverButton" data-toggle="modal" data-target="#nounModal">Create Noun Group <i class="far fa-edit"></i></a>
		</div>
	</div>
	<br>
          	...
          	<tbody>
	         	@foreach($noun_table as $noun_data)
	         		<tr>
	         			...
	         			@else
	         				<td><img src="{{url('/storage/'.$noun_data->menu_cat_image.'')}}" style="" class="img-fluid"></td>
	         			@endif
	         			<td>
